...
-----------------------------------------------------------------------------------------------
@EjecucionBackup VARCHAR(17), --VARIABLE PARA FECHA Y HORA DE EJECUCION BACKUP
...
IF @TipoBackup = 'FULL'
  SET @Comando = @Comando + N' TO DISK = '''+@RutaBackup+@BaseDatos+N'_FULL_'+@EjecucionBackup+N'.bak''' 
ELSE
  IF @TipoBackup = 'DIFF'
    SET @Comando = @Comando + N' TO DISK = '''+@RutaBackup+@BaseDatos+N'_DIFF_'+@EjecucionBackup+N'.bak''' 
  ELSE
    SET @Comando = @Comando + N' TO DISK = '''+@RutaBackup+@BaseDatos+N'_LOG_'+@EjecucionBackup+N'.trn''' 
